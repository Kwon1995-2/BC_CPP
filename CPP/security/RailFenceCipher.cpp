...
void Keylessencry(char*, int, int);
void Keylessdecry(char*, int, int);
...
int main(void)
{
	...
	Keylessencry(c_text, str_size, rail);
	cout << c_text << endl;
...
void Keylessencry(char* _ct, int s, int n)
{

	char tmp_text[n][20] = { 0, }; //변수인 s를 상수처럼 사용 못 함
...
void Keylessdecry(char* _ct, int s, int n)
{
