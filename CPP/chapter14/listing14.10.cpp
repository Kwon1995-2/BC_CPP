...
int main(void)
{
	...
	attorney.first = "HongGilDong";
	attorney.last = "taxi";
	printf("main::accountant = %s and %s\n", accountant.first, attorney.first);
	puts("Enter the last name of your accountant:");
	//scanf("%s", attorney.last);//예외 오류가 발생함
	puts("Enter the last name of your attorney:");
	//attorney = veep;//veep의 type과 attorney의 type이 다르다
	attorney = treas;
	printf("main::attorney.last = %s and attorney.first = %s\n", attorney.last, attorney.first);
...
void getinfo(struct namect* pst)
{
	...
	//pst->fname = "Hong";//error 발생 strcpy()에서 
