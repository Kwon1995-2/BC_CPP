...
#include <stdio.h> 
#include <string.h> //c언어 문자열을 처리하는 함수들
#include <ctype.h> //문자들을 조건에 맞는지 검사하고 변환하는 함수들 포함
#include <stdlib.h>
...
int main(void)
{
	...
	void(*pfun)(char*); // points a function having a //함수를 가리키는 포인터
	// char * argument and no
	// return value
	pfun = Dummy; //Dummy 함수를 pfun에 대입
...
void show(void(*fp)(char*), char* str) // 함수포인터 이용해서 함수호출
{
